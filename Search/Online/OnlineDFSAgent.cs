namespace AIMA.Core.Search.Online
{
    ...
    public class OnlineDFSAgent : AbstractAgent
    {
        ...
        // persistent: result, a table, indexed by state and action, initially empty
        private TwoKeyHashMap<Object, Action, Object> result = new TwoKeyHashMap<Object, Action, Object>();
        // untried, a table that lists, for each state, the actions not yet tried
        private Map<Object, List<Action>> untried = new HashMap<Object, List<Action>>();
        // unbacktracked, a table that lists,
        // for each state, the backtracks not yet tried
        private Map<Object, List<Object>> unbacktracked = new HashMap<Object, List<Object>>();
        // s, a, the previous state and action, initially null
