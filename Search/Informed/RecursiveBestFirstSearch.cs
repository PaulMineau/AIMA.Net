 ...
 * 
 */
public class RecursiveBestFirstSearch : NodeExpander , Search {

	private EvaluationFunction evaluationFunction;

	private const String MAX_RECURSIVE_DEPTH = "maxRecursiveDepth";

	private const String PATH_COST = "pathCost";

	private const Double INFINITY = Double.MAX_VALUE;
