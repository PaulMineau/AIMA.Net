...
namespace AIMA.Probability
{
    ...
    public abstract class Factor
    {
        ...
        public abstract class Iterator
        {
          ...
          abstract public  void iterate(Map<RandomVariable, Object> possibleAssignment,
                         double value);
        }
         ...
         */
        abstract public Set<RandomVariable> getArgumentVariables();
       ...
       abstract public double[] getValues();
         ...
         */
       abstract public Factor sumOut(params RandomVariable[] vars);
         ...
         */
       abstract public Factor pointwiseProduct(Factor multiplier);
       ...
       abstract public Factor pointwiseProductPOS(Factor multiplier,
         ...
         */
       abstract public void iterateOver(Iterator fi);
         ...
         *            this Factor.
         */
       abstract public void iterateOver(Iterator fi, params AssignmentProposition[] fixedValues);
    }
}