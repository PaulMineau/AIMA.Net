 ...
 */
	 ...
	 */
        ...
        private class ProbabilityTableIterator : IEnumerator<ProbabilityTable>
        {
            private Map<RandomVariable, Object> possibleWorld;

            public ProbabilityTableIterator(Map<RandomVariable, Object> possibleWorld)
            {
                this.possibleWorld = possibleWorld;
            }

            public ProbabilityTable  Current
            {
        ...
        protected class ObservedEvidence
        {
            ...
            private Map<RandomVariable, int> varIdxs = new Map<RandomVariable, int>();
