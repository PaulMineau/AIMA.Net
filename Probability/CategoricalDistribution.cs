...
namespace AIMA.Probability
{
    ...
    public abstract class CategoricalDistribution : ProbabilityMass
    {
        ...
        public abstract class  Iterator
        {
           ...
           public abstract void iterate(Map<RandomVariable, Object> possibleAssignment,
                         double probability);
        }
         ...
         */
        public abstract CategoricalDistribution normalize();
         ...
         */
        public abstract int getIndex(params Object[] values);
         ...
         *         values.
         */
        public abstract CategoricalDistribution marginal(params RandomVariable[] vars);
         ...
         */
        public abstract void iterateOver(Iterator cdi);
         ...
         */
        public abstract void iterateOver(Iterator cdi, params AssignmentProposition[] fixedValues);
    }
}