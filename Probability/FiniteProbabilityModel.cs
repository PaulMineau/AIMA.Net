...
namespace AIMA.Probability
{
    ...
    public abstract class FiniteProbabilityModel : ProbabilityModel
    {
         ...
         */
        private CategoricalDistribution priorDistribution(params IProposition[] phi);
         ...
         */
        private CategoricalDistribution jointDistribution(params IProposition[] propositions);
    }
