...
namespace AIMA.Environment.CellWorld
{
     ...
     * <br>
     * <b>Note:<b> the x and y coordinates are always positive ints starting at
     * 1.<br>
    ...
    public class CellWorld<C>
    {
        ...
        private Map<int, Map<int, Cell<C>>> cellLookup = new Map<int, Map<int, Cell<C>>>();
        ...
        public CellWorld(int xDimension, int yDimension, C defaultCellContent)
        {
            ...
            {
                Map<int, Cell<C>> xCol = new Map<int, Cell<C>>();
        ...
        {
            Map<int, Cell<C>> xCol = cellLookup.get(x);
            if (null != xCol)
            {
