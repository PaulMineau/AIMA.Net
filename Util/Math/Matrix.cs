...
public class Matrix {
    ...
    //    print(new PrintWriter(System.Console.Out, true), w, d);
    //}
    ...
    //    print(new PrintWriter(System.Console.Out, true), format, width);
    //}
    ...
    //    do {
    //        v.Add(Convert.ToDouble(tokenizer.sval)); // Read & store 1st
    //        // row.
    ...
    //        do {
    //            if (j >= n)
    //                throw new System.IO.IOException("Row " + v.Count
    //                        + " is too long.");
    //            row[j++] = Convert.ToDouble(tokenizer.sval);
    //        } while (tokenizer.nextToken() == StreamTokenizer.TT_WORD);
    //        if (j < n)
    //            throw new IOException("Row " + v.Count
    //                    + " is too short.");
    //    }
