...
namespace RTools.Util
{
    ...
    /// once and get an List of Tokens (see the Tokenize* methods), 
    ...
    public class StreamTokenizer
    {
        ...
        /// in the input List. This resets the line number to 1.
        /// </summary>
        /// <param name="tokens">The List to append to.</param>
        /// <returns>bool - true for success</returns>
        ...
        /// <param name="tokens">The List to put tokens in.</param>
        /// <returns>bool - true for success, false for failure.</returns>
