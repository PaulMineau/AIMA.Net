namespace aima.test.core.unit.environment.tictactoe;
...
using AIMA.Core.Environment.TicTacToe.TicTacToe;
using AIMA.Core.Environment.TicTacToe.TicTacToeBoard;
using AIMA.Core.Search.Adversarial.AlphaBeta;
using AIMA.Core.Search.Adversarial.GameState;
...
public class TicTacToeTest {
	 ...
	 * t4.minValue(t4.getState()); System.Console.WriteLine("j = " + j);
